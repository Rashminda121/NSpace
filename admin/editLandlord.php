...
if (isset($_POST['update_landlord'])) {
    ...
    header("Location: ViewEditLandlord.php");
    exit;
}
  ...
  <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Edit Landlord Details</h2>
    <form action="" method="POST" class="space-y-8">
          ...
          <div>
              ...
              <input type="text" id="lmobile" name="lmobile" pattern="[0-9]{10}" title="Please add 10 digits only" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" value="<?php echo $landlord['lmobile']; ?>" placeholder="Landlord Mobile" required>
          </div>
          <div class="w-full">
