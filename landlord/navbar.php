  ...
  <a href="#" class="flex items-center space-x-2 rtl:space-x-reverse">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul
        ...
        <li class="mt-1">
          <a href="#"
          class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Articles</a>
        </li>

        <li class="mt-1">
          <a href="propertyView.php?email=<?php echo $email ?>"
          class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Properties</a>
        </li>
        <li class="mt-1">
          <a href="propertyQuestions.php?email=<?php echo $email ?>"
          class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Questions</a>
        </li>
        <li class="mt-1">
