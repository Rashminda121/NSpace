...
<<<<<<< HEAD
            <?php
            // Loop through each fetched article and display them
            while ($row = $result->fetch_assoc()) {
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        ...
                        <span class="text-sm"><?php echo $row['date']; ?></span>
                    </div>
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#"><?php echo $row['title']; ?></a></h2>
                    <p class="mb-5 font-light text-gray-500 dark:text-gray-400"><?php echo $row['content']; ?></p>
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-4">
                            <img class="w-7 h-7 rounded-full" src="image/blogP.png" alt="Author avatar" />
                            <span class="font-medium dark:text-white"><?php echo $row['name']; ?></span>
                        </div>
=======
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center mb-5 text-gray-500">
                    ...
                    <span class="text-sm">2024-03-09</span>
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        <img class="w-7 h-7 rounded-full" src="image/blogP.png" alt="Jese Leos avatar" />
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        <img class="w-7 h-7 rounded-full" src="image/blogP.png" alt="Bonnie Green avatar" />
                        <span class="font-medium dark:text-white">Bonnie Green</span>
>>>>>>> 30ff0f7ea74eb9bcee86cf888835c5f401a52218
                    </div>
                </article> 
            <?php
            }
