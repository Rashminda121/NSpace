...
<body>
  ...
  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      <h2 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white"><center>Add a New Article</center></h2>
      <br>
      <form action="#">
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
              ...
              <div class="w-full">
                  <label for="brand" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Author Name</label>
